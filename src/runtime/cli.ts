...
function usageRoot(): string {
  return [
    ...
    "  A flow is a direct role-to-role handoff after the source role completes its work.",
...
function usageVisualizer(): string {
  return [
    ...
    "",
    "Graph meaning:",
    "  Nodes are responsibility roles/agents, not events, actions, or process steps.",
    "  Edges are role-to-role flows/handoffs; edge labels carry events or handoff outcomes.",
