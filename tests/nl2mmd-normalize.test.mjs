...
%% model.bind.debate-judge=general-balanced
%% model.bind.debate-summary=general-balanced
...
%% model.bind.debate-alignmentist=fast-gpt54
%% model.bind.debate-judge=fast-gpt54
