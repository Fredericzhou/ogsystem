...
- data: include compensation.action and compensation.verified=true when event is COMPENSATED
...
- Do not claim an action was verified unless the output or an external check confirms it.
